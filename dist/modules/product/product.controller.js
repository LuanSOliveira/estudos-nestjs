...
let ProductController = class ProductController {
    ...
    async createProjetc(createProduct) {
        const newProject = await this.productService.createProduct(createProduct);
        return {
            user: new find_product_dto_1.FindProductDTO(newProject.id, newProject.name),
...
], ProductController.prototype, "createProjetc", null);
__decorate([
    (0, common_1.Get)(),
    __metadata("design:type", Function),
